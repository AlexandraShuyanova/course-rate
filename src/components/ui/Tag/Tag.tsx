...
const styles = {
    ...
    primary: 'inline-flex items-center justify-center py-[3px] px-[9px] h-[22px] font-medium rounded-[20px] bg-transparent border border-[var(--primary)] text-[var(--primary)] cursor-pointer text-[13px] leading-[15px]',
}

export function Tag({ variant='ghost', children, href, className, ...props}: TagProps) {
    return (
